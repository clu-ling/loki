...
def serializedATN():
    with StringIO() as buf:
        ...
        buf.write("\3\f\3\f\3\f\3\f\3\r\3\r\5\rS\n\r\3\16\6\16V\n\16\r\16")
        buf.write("\16\16W\3\16\3\16\3\17\3\17\7\17^\n\17\f\17\16\17a\13")
        buf.write("\17\3\17\3\17\3\20\3\20\3\20\3\20\3\20\5\20j\n\20\3\21")
        buf.write("\3\21\3\21\2\2\22\2\4\6\b\n\f\16\20\22\24\26\30\32\34")
        buf.write("\36 \2\6\3\2\25\27\3\2\b\b\3\2\26\27\3\2\r\24\2i\2$\3")
        buf.write("\2\2\2\4,\3\2\2\2\6.\3\2\2\2\b\60\3\2\2\2\n\62\3\2\2\2")
        buf.write("\f\66\3\2\2\2\16:\3\2\2\2\20A\3\2\2\2\22D\3\2\2\2\24J")
        buf.write("\3\2\2\2\26L\3\2\2\2\30R\3\2\2\2\32U\3\2\2\2\34[\3\2\2")
        buf.write("\2\36i\3\2\2\2 k\3\2\2\2\"%\5\16\b\2#%\5\4\3\2$\"\3\2")
        buf.write("\2\2$#\3\2\2\2%&\3\2\2\2&$\3\2\2\2&\'\3\2\2\2\'\3\3\2")
        buf.write("\2\2(-\5\n\6\2)-\5\f\7\2*-\5\6\4\2+-\5\b\5\2,(\3\2\2\2")
        buf.write(",)\3\2\2\2,*\3\2\2\2,+\3\2\2\2-\5\3\2\2\2./\7\3\2\2/\7")
        buf.write("\3\2\2\2\60\61\7\4\2\2\61\t\3\2\2\2\62\63\7\13\2\2\63")
        buf.write("\64\5\24\13\2\64\13\3\2\2\2\65\67\7\f\2\2\66\65\3\2\2")
        buf.write("\2\66\67\3\2\2\2\678\3\2\2\289\5\24\13\29\r\3\2\2\2:=")
        buf.write("\7\5\2\2;>\5\22\n\2<>\5\20\t\2=;\3\2\2\2=<\3\2\2\2>?\3")
        buf.write("\2\2\2?@\7\6\2\2@\17\3\2\2\2AB\7\7\2\2BC\5\22\n\2C\21")
        buf.write("\3\2\2\2DE\5 \21\2EF\7\t\2\2FG\5\24\13\2G\23\3\2\2\2H")
        buf.write("K\5\26\f\2IK\5\36\20\2JH\3\2\2\2JI\3\2\2\2K\25\3\2\2\2")
        buf.write("LM\7\b\2\2MN\5\32\16\2NO\7\b\2\2O\27\3\2\2\2PS\5\34\17")
        buf.write("\2QS\5\32\16\2RP\3\2\2\2RQ\3\2\2\2S\31\3\2\2\2TV\t\2\2")
        buf.write("\2UT\3\2\2\2VW\3\2\2\2WU\3\2\2\2WX\3\2\2\2XY\3\2\2\2Y")
        buf.write("Z\n\3\2\2Z\33\3\2\2\2[_\7\25\2\2\\^\t\4\2\2]\\\3\2\2\2")
        buf.write("^a\3\2\2\2_]\3\2\2\2_`\3\2\2\2`b\3\2\2\2a_\3\2\2\2bc\7")
        buf.write("\25\2\2c\35\3\2\2\2de\7\n\2\2ef\5\30\r\2fg\7\n\2\2gj\3")
        buf.write("\2\2\2hj\5\34\17\2id\3\2\2\2ih\3\2\2\2j\37\3\2\2\2kl\t")
        buf.write("\5\2\2l!\3\2\2\2\f$&,\66=JRW_i")
        return buf.getvalue()
...
class LokiParser ( Parser ):
    ...
    symbolicNames = [ "<INVALID>", "<INVALID>", "<INVALID>", "<INVALID>", 
                      "<INVALID>", "NEGATED", "SLASH", "EQUAL", "QUOTE", 
    ...
    RULE_inner_pattern = 11
    RULE_regex = 12
    RULE_literal = 13
    RULE_pattern_literal = 14
    ...
    ruleNames =  [ "loki_pattern", "graph_traversal", "incoming_wildcard", 
                   ...
                   "pattern", "pattern_regex", "inner_pattern", "regex", 
                   "literal", "pattern_literal", "token_attribute" ]
    ...
    def loki_pattern(self):
        ...
        try:
            ...
            while True:
                ...
                self._errHandler.sync(self)
                _la = self._input.LA(1)
                if not ((((_la) & ~0x3f) == 0 and ((1 << _la) & ((1 << LokiParser.T__0) | (1 << LokiParser.T__1) | (1 << LokiParser.T__2) | (1 << LokiParser.SLASH) | (1 << LokiParser.QUOTE) | (1 << LokiParser.INCOMING_DEP) | (1 << LokiParser.OUTGOING_DEP) | (1 << LokiParser.LETTER))) != 0)):
                    break
    ...
    def inner_pattern(self):
        ...
        self.enterRule(localctx, 22, self.RULE_inner_pattern)
        try:
            self.state = 80
            self._errHandler.sync(self)
    ...
    class RegexContext(ParserRuleContext):
        ...
        def SLASH(self):
            return self.getToken(LokiParser.SLASH, 0)
    ...
    def regex(self):
        ...
        try:
            ...
            self.state = 87
            _la = self._input.LA(1)
            if _la <= 0 or _la==LokiParser.SLASH:
                self._errHandler.recoverInline(self)
            else:
                self._errHandler.reportMatch(self)
                self.consume()
    ...
    class Pattern_literalContext(ParserRuleContext):
        ...
        def inner_pattern(self):
            return self.getTypedRuleContext(LokiParser.Inner_patternContext,0)
    ...
    def pattern_literal(self):
        ...
        self.enterRule(localctx, 28, self.RULE_pattern_literal)
        try:
            self.state = 103
            self._errHandler.sync(self)
            token = self._input.LA(1)
